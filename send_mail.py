...
if __name__ == '__main__':
    ...
    subject, from_email, to = '来自www.liujiangblog.com的测试邮件', 'f8770@sina.cn', '87702755@qq.com'
    text_content = '欢迎访问 www.liujiangblog.com，这里是刘江的博客和教程站点，专注于Python和Django技术的分享！'
